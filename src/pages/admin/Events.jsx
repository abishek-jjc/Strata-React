...
const baseFields = [
  ...
  { name: 'has_prelims', label: 'Has Preliminary Round', type: 'toggle', persist: false },
  { name: 'prelims_venue', label: 'Prelims Venue', type: 'select', options: [], showIf: (form) => !!form.has_prelims },
  { name: 'preliminary', label: 'Preliminary Round Time', type: 'time', showIf: (form) => !!form.has_prelims },
